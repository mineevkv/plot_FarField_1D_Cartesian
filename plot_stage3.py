...
theta, dBi, angular_3dB = calc('stage3/f220_phi0.txt')
...
theta, dBi, angular_3dB = calc('stage3/f240_phi0.txt')
...
ax.set_ylabel('dBi')
plt.show()
fig.savefig('stage3/phi0.png', dpi=300)
...
theta, dBi, angular_3dB = calc('stage3/f220_phi90.txt')
plt.plot(theta, dBi, color='b', label='220 GHz $\\theta_{-3 \,dB} = ' + str(angular_3dB) + '\\degree$')

theta, dBi, angular_3dB = calc('stage3/f230_phi90.txt')
plt.plot(theta, dBi, color='r', label='230 GHz $\\theta_{-3 \,dB} = ' + str(angular_3dB) + '\\degree$')

theta, dBi, angular_3dB = calc('stage3/f240_phi90.txt')
plt.plot(theta, dBi, color='g', label='240 GHz $\\theta_{-3 \,dB} = ' + str(angular_3dB) + '\\degree$')
...
fig.savefig('stage3/phi90.png', dpi=300)
